...
However, this deterministic framework breaks down when confronted with the reality of financial markets. Markets are not clockwork mechanisms. They are influenced by an endless stream of unpredictable factors: economic news releases, geopolitical events, shifts in investor sentiment, regulatory changes, and countless individual trading decisions. Each of these introduces its own small element of randomness that cannot be captured by deterministic equations alone. To model these systems realistically, we need to use a mathematical tool that can incorporate both the underlying trends and the inherent uncertainty, and this is where stochastic differential equations enter the picture.`,
    content: [
      ...
      {
        type: "p",
        text: `Stochastic differential equations represent a very powerful mathematical framework for modelling systems, and it is influenced both by deterministic forces and random fluctuations.`,
      },
      {
        type: "p",
        text: `In physics and finance, we understand many quantities evolve over time, from particle positions, to temperature distributions and stock prices. When the future of this evolution is perfectly predictable from initial conditions, we can use ordinary differential equations (ODEs). A simple example is exponential growth, $\\frac{dx}{dt} = kx$, which tells us exactly what $x(t)$ will be at any moment in time given the initial value and growth constant k.`,
      },
      {
        type: "p",
...
price buffeted by market forces is remarkable.`,
      ...
      {
        type: "p",
        text: `As early as c. 60 BC, humans had at least commented on the erratic behaviour of particles within a fluid. In his poem De Rerum
Natura (‘On the Nature of Things’), Lucretius describes dust particles illuminated by a setting sun. This is likely the first recorded
observation of the stochastic process that applies modern financial systems. Although what Lucretius saw was likely caused not
by true Brownian motion but by air currents, he at least "perfectly describes and explains the Brownian movement by a wrong
example". Crucially, Lucretius concludes that microscopic collisions cause general macroscopic motion. This forms the basis for
...
position $X_n$ after n steps is defined by`,
      ...
      {
        type: "math",
        text: `$X_n = \\sum_{i=1}^{n} Z_i$`,
      },

      {
        type: "p",
        text: `where $Z_i$ represents the Lucretius’ ‘invisible’ collisions. Formally we now call $Z_i$ stochastic increments. Note that $n \\in N$. The
next known observation of stochastic motion arrives from the Dutch Physicist Jan Ingenhousz. He notes the irregular movement
of finely powdered charcoal suspended in alcohol. Some historians claim this as the first experimental discovery of what Brown
has been accredited for. However, our analysis of primary sources reveals this is likely not the case. Strict Brownian motion
requires a state of thermal equilibrium, yet in Ingenhousz’s analysis, the use of uncovered alcohol created rapid evaporation.
...
particle's radius a,`,
      ...
      {
        type: "math",
        text: `$$D = \\frac{k_B T}{6\\pi\\eta a}$$`,
      },

      {
        type: "p",
        text: `To explain why Ingenhousz's observation of 100μm charcoal particles (where a = 50μm) fails the criteria for Brownian motion,
we calculate the root mean square (RMS) displacement $\\Delta x$ over a time interval t:`,
      },

      {
        type: "math",
        text: `$$\\sqrt{\\langle \\Delta x^2 \\rangle} = \\sqrt{2Dt}$$`,
      },

      {
        type: "p",
        text: `Using the viscosity of ethanol ($\\eta \\approx 1.2 \\times 10^{-3}$ Pa·s) at room temperature (T = 293 K), the diffusion coefficient for a particle
of this size is approximately $D = 3.5 \\times 10^{-15}$ m²/s. For an observation period of t = 1s, the displacement is:`,
      },

      {
        type: "math",
        text: `$$\\Delta x = \\sqrt{2(3.5 \\times 10^{-15})(1)} = 8.4 \\times 10^{-8} m = 0.084\\mu m$$`,
      },

      {
        type: "p",
        text: `Because the displacement (0.084μm) is less than 0.1% of the particle's diameter (100μm), the motion would be imperceptible
under the microscopes of 1784. Therefore, the “violent" motion Ingenhousz saw was not stochastic diffusion, but likely
convection caused by evaporation. In financial terms, this is the equivalent of a “high-beta" environment where the volatility of a
single stock is completely drowned out by a massive market-wide trend. The underlying stochasticity exists, but the Péclet-like
ratio of the market indicates that the systemic drift $\\mu$ has overwhelmed the idiosyncratic diffusion $\\sigma$.`,
      ...
      {
        type: "p",
        text: `Whilst Norbert Wiener is lauded for his contributions to financial physics, before him there was Louis Bachelier (1870-1946). In his dissertation (written in Paris in 1900) and his subsequent work, he predicted much that was to come in financial physics, namely random walks and Brownian Motion. In his thesis, he had worked out the Wiener process and linked it mathematically to the diffusion equation, before both Einstein and Wiener.`,
      },

      {
        type: "p",
        text: `Bachelier assumed that the movement of a price of an infinitesimal time period dt followed a normal distribution with a mean of 0. He established in his mathematical formulation that the total displacement x after time t is a random variable. Bachelier also argued that the variance must be proportional to the time elapsed in order for the process to be consistent, leading to the equation:`,
      },

      {
        type: "math",
        text: `$Var(x) = \\sigma^2 t$`,
      },

      {
        type: "p",
        text: `where $\\sigma$ is the volatility. This led to the insight that the 'scatter' of the random work grows proportionally to $t^{0.5}$, not t.`,
      },
      ...
      {
        type: "math",
        text: `$$\\frac{\\delta P}{\\delta t} = D(\\frac{\\delta^2 P}{\\delta x^2})$$`,
      },

      {
        type: "p",
        text: `In the context of finance, D represents the diffusion coefficient, which is related to the market volatility.`,
      },

      {
        type: "p",
        text: `Whilst Bachelier remained unknown compared to Einstein and Wiener during and after his, nowadays he is recognised internationally as the father of financial mathematics.`,
      },

      {
        type: "p",
        text: `However, Brownian motion showed no uses to the financial industry until mathematician Norbert Wiener
defined the Wiener process in 1918. Wiener defined a way to calculate the probability of a particle
taking a specific set of paths - this is known as the Wiener process.`,
      },
      ...
      {
        type: "p",
        text: `The basic Wiener process can take negative values, which made it unsuitable for direct stock price
modelling. Stock prices, after all, cannot fall below zero, a company's value may plummet, but it cannot
become negative. Therefore, the mathematical framework was adapted to create Geometric Brownian Motion (GBM),
which ensures price changes are proportional to the current price level.`,
      },
...
The basic Wiener process can take negative values, which made it unsuitable for direct stock price modelling. Therefore the mathematical framework was adapted to create Geometric Brownian Motion (GBM), which allows price changes proportional to the current price.`,
    content: [
      ...
      {
        type: "p",
        text: `Although physically Brownian motion represents the motion of a particle, the Wiener process generalises the idea of a particle to just represent some variable, $W$. This variable can adopt a range of meanings, including representing the stock price in financial modelling.`,
      },
      {
        type: "p",
        text: `The Wiener process is characterised by the following properties:`,
      },

      {
        type: "p",
        text: `$W(0) = 0$ almost surely. This means that the initial value of our variable $W$ (in this case the price of the stock) starts from a value of 0.`,
      },
      {
        type: "p",
        text: `$W$ has independent increments: for every $t > 0$: $W_{t+u} - W_t, u \\ge 0,$ are independent of the past values $W_s, s < t.$`,
      },
      {
        type: "p",
        text: `$W$ has Gaussian increments - a time step $u$ results in an increment that is normally distributed with mean 0 and variance $u$.`,
      },
      {
        type: "p",
        text: `$W$ has almost surely continuous paths: $W_t$ is almost surely continuous in $t$. i.e. $W$ has no sudden jumps - it passes through all intermediate values to get from one point to another.`,
      },

      {
        type: "p",
        text: `In the above conditions, "almost surely" is a probability term - this means that the probability of the condition being true is 100%.`,
      },
      {
        type: "p",
        text: `The basic Wiener process can take negative values, which made it unsuitable for direct stock price modelling. Therefore the mathematical framework was adapted to create Geometric Brownian Motion (GBM), which allows price changes proportional to the current price.`,
      },
...
The above figure demonstrates how a typical volatility cycle takes place. Before the volatility spike, the volatility gradually increases up until the peak, and then decreases back down to around the initial volatility value.`,
    content: [
      ...
      {
        type: "p",
        text: `The term $b(X,t)$ is the diffusion coefficient, sometimes called the volatility function. It determines the magnitude of random fluctuations, essentially, how much the system can be knocked around by random forces. Crucially, this can also depend on the current state, meaning that uncertainty itself can be state-dependent. In financial markets, we often observe that volatility increases during periods of market stress, for example an asset that has fallen sharply would likely exhibit greater price swings than one trading calmly.`,
      },
      {
        type: "p",
        text: `The term $dW$ represents an infinitesimal increment of Brownian motion, which we explored in the previous section. This is the source of all randomness in the equation.`,
      },
      {
        type: "p",
        text: `Mathematically, $dW$ behaves like $\\sqrt{dt}$ multiplied by a standard normal random variable $Z$. This scaling is important, because it means that over longer time intervals, the random effects accumulate in a specific way, growing proportionally to the square root of time rather than linearly. This is fundamentally different from deterministic systems and reflects the diffusive nature of random processes.`,
      },
      {
        type: "p",
        text: `One might wonder why we write $dX$ rather than a traditional derivative like`,
      },
      {
        type: "math",
        text: `$$
...
$$`,
      ...
      {
        type: "p",
        text: `This is because paths generated by SDEs are typically not differentiable in the classical sense. Brownian motion, despite being continuous, has such irregular, jagged paths that they have infinite variation, so you cannot compute a traditional derivative at any point.`,
      },
      {
        type: "p",
        text: `The notation $dX$ represents an infinitesimal change interpreted in a specific mathematical sense, either through Itô calculus or Stratonovich calculus (but those are far too complex for you to do at this stage), which provide rigorous foundations for manipulating these objects.`,
      },
...
The drift parameter $\\mu$ dictates that general trend of an asset, which is separate from its volatility, which is fluctuating. If $\\mu > 0$, then the trend of the asset is upwards, and if $\\mu < 0$, then the general trend is downwards. In the absence of volatility, the expected value of the stock price at time T is:`,
      ...
      {
        type: "math",
        text: `$$E[S(T)] = S(0)e^{\\mu T}$$`,
      },
      {
        type: "p",
        text: `The drift is often mistaken with the realised growth, which is the growth rate of the 'typical' path. By contrast, the drift is the average of all possible future outcomes.`,
      },
      {
        type: "p",
        text: `For running simulations in real market scenarios, historical performance is often used to estimate the drift.`,
      },
      {
        type: "p",
        text: `Depending on the current value of the drift, the market can be split into different categories: bull markets, bear markets, and sideways markets. Bull markets allude to a positive drift, where asset prices tend to increase. In a bull market, the conditions of the economy are generally favourable, for example when there is strong economic growth, high investor confidence and low unemployment.`,
      },
      {
        type: "p",
        text: `On the other hand, negative drift indicates a bear market. In a bear market, asset prices tend to fall. Bear markets are often triggered by factors such as rising inflation and economic slowdowns, which weaken investor confidence. Bear markets can last from a few weeks to years. One of the last prolonged bear markets occurred in the US between 2007-2009 during the Financial Crisis, and this bear market last around 17 months, indicating a long term period of negative drift.`,
      },
      {
        type: "p",
        text: `Sideways markets occur when the drift lies at around zero. In a sideways market, asset prices tend to stay roughly the same - there is no trend to asset prices. During a sideways market, trading volume tends to remain balanced. This means that investors are not rushing to buy or sell, and thus the market remains steady and balanced. There may be spikes in asset prices during a bear market, but these do not have an underlying trend.`,
      },
      {
        type: "p",
        text: `The diffusion coefficient in GBM is directly related to the volatility of the market.`,
      },
      {
        type: "math",
        text: `$$D(x) = \\frac{\\sigma^2 x^2}{2}$$`,
      },
      {
        type: "p",
        text: `where D is the diffusion coefficient, $\\sigma$ is the volatility and $x$ is the current price of the stock. This differs to standard Brownian motion, where the diffusion coefficient is constant.`,
      },
      {
        type: "p",
        text: `In turbulent markets, the volatility $\\sigma$ is higher. This in turn means that the diffusion coefficient is higher, reflecting a wider, faster spread in potential price outcomes. Turbulent markets tend to occur during periods of high uncertainty, such as during financial crashes, during extreme political tensions or other international disasters. For example, one of the highest volatilities ever recorded was in March 2020 during the COVID-19 pandemic, where the Cboe Volatility Index (VIX) reached a closing high of 82.69.`,
      },
      {
        type: "p",
...
\\]`,
      ...
      {
        type: "p",
        text: `This model ensures that asset prices have a natural lower bound of 0. However, it does allow the percentage change in price to become negative, i.e. the price is allowed to fall.`,
      },
      {
        type: "p",
        text: `The parameter $\\mu$ represents the average growth rate or expected return of the asset. The parameter $\\sigma$ represents the volatility, a measure of how severely and frequently the price fluctuates around its trend. The multiplicative structure ensures that $S$ remains strictly positive for all time, provided it starts positive.`,
      },
      {
        type: "p",
        text: `Although GBM does have an exact analytical solution, most SDEs encountered in practice do not. In these cases, we must resort to using numerical methods like the Euler-Maruyama method. We divide the time interval $[0, T]$ into $N$ small steps of size`,
      },
      {
        type: "math",
        text: `\\[
...
\\]`,
      ...
      {
        type: "p",
        text: `We then approximate the continuous SDE by a discrete-time recursion:`,
      },
      {
        type: "math",
        text: `\\[
...
\\]`,
      ...
      {
        type: "p",
        text: `For Geometric Brownian Motion specifically, the scheme becomes`,
      },
      {
        type: "math",
        text: `\\[
...
\\]`,
      ...
      {
        type: "p",
        text: `The algorithm is straightforward. We begin with the initial condition $S_0$.
At each time step, we draw a random number $Z$ from a standard normal distribution.
We then update the price using the formula above. We repeat this process for $N$ steps
until we reach the final time $T$. The result is a single simulated path, with one
possible trajectory that the stock price might follow given the model parameters.`,
...

 {
  ...
  content: [
    ...
    {
      type: "p",
      text: `The procedure involves running the Euler–Maruyama algorithm thousands or millions of times. Each run produces a different trajectory $S_1(t), S_2(t), ..., S_m(t)$. From this group of runs, we can compute the mean final price, the variance, percentiles for risk assessment, and probabilities of extreme outcomes.`,
    },
    {
      type: "p",
      text: `Monte Carlo methods are particularly valuable because they scale well to high-dimensional problems. For a portfolio of $n$ correlated assets, we can simply simulate all processes simultaneously at each time step.`,
    },
    {
      type: "p",
      text: `Now we can see above that we have ended up with a terminal distribution composed of terminal prices from each simulation due to the solution of GBM. This is lognormal, which is different from a normal distribution. Also, this is composed of many different pathways. This is not an exact lognormal distribution; rather, we call this the empirical lognormal distribution.`,
    },

    { type: "p", text: `From here, what can we learn?` },

    {
      type: "p",
      text: `Median: this is the value such that 50% of simulated terminal prices lie below it and 50% lie above it. Since the lognormal distribution is unimodal and right-skewed (not symmetric), the median represents a “typical” central outcome by probability mass. This is useful when you want a typical outcome that is not overly affected by rare extreme high values.`,
    },
    {
      type: "p",
      text: `Mean: this tells us the expected price at the end, but having one choice of price isn't using the full potential of this method. For skewed distributions like the lognormal, the mean is typically pulled upward by the right tail. This is useful when you care about the average outcome across repeated trials.`,
    },
    {
      type: "p",
      text: `Interval: from this empirical distribution we can calculate intervals of uncertainty such as a 95% interval, and the extreme cases. This is useful in two senses. One is that we can calculate the probability of this asset reaching a certain price, $P(\\text{price} > \\text{target}) = x\\%$. For example, after simulating $m$ paths, we can estimate $x\\%$ by counting what fraction of terminal prices satisfy $S(T) > \\text{target}$. From there, it helps us make decisions on what to do and risk hedge.`,
    },

    {
      type: "p",
      text: `Now, talking of risk hedge, this is a very simple lognormal distribution, so it seems like picking a single price is straightforward, but there are other distributions that are harder to do so. Thus, I will explain the basic framework of how to decide the optimal point in this distribution, which is part of decision theory.`,
    },

    {
      type: "p",
      text: `Let $a$ be the single price (or estimate) we choose to represent the terminal outcome $S(T)$. The whole objective is where we assign a loss function, which is a penalty for being off from the real value, and pick $a$ that has the least penalty on average across the distribution. In other words, we want to minimize expected loss:
\\[
a^* = \\arg\\min_a\\ \\mathbb{E}\\big[L(a, S(T))\\big].
\\]
In Monte Carlo we approximate this expectation by averaging across the simulated terminal prices.`,
    },

    {
      type: "p",
      text: `There are so many loss functions we can assign, but let me introduce two very basic ones.`,
    },

    {
      type: "p",
      text: `Squared loss: $L(a,S) = (a - S)^2$. This means it will penalize more when it is further away, in which case $a = \\mathbb{E}[S]$. A simple proof is:`,
    },

    {
      type: "p",
      text: `Let $S$ be the (random) terminal price and choose a single number $a$. With quadratic loss $L(a,S)=(a-S)^2$, we want
\\[
a^* = \\arg\\min_a\\ \\mathbb{E}\\big[(a-S)^2\\big].
\\]
Expand the square:
\\[
\\mathbb{E}\\big[(a-S)^2\\big]
= \\mathbb{E}\\big[a^2 - 2aS + S^2\\big]
= a^2 - 2a\\,\\mathbb{E}[S] + \\mathbb{E}[S^2].
\\]
Treat this as a function of $a$:
\\[
f(a)= a^2 - 2a\\,\\mathbb{E}[S] + \\mathbb{E}[S^2].
\\]
Differentiate and set to zero:
\\[
f'(a)=2a - 2\\mathbb{E}[S] = 0
\\quad\\Rightarrow\\quad
a=\\mathbb{E}[S].
\\]
Since $f''(a)=2>0$, this is a minimum. Therefore $a^*=\\mathbb{E}[S]$.`,
    },

    {
      type: "p",
      text: `Absolute error: similar idea, except it penalizes linearly rather than quadratically, and it leads to an optimal choice that matches the median rather than the mean.`,
    },

    { type: "p", text: `Now you might wonder: was this all needed? Well, sort of.` },

    {
      type: "p",
      text: `This is the mathematical bookkeeping, since mean and median aren't random; they are optimal answers to different objectives.`,
    },

    {
      type: "p",
      text: `With more sophisticated models, there is no guarantee that you will get a nice, simple output. At this time this bookkeeping process becomes absolutely crucial.`,
    },
    ...
    {
      type: "p",
      text: `To add on, there are different, more finance-focused loss functions, but they are usually defined on loss or P&L rather than directly on price. For example, if we define a loss variable $X$ (such as negative return or negative profit-and-loss), then VaR at level $\\alpha$ is an $\\alpha$-quantile of $X$, and CVaR is the average loss in the worst $\\alpha\\%$ outcomes. The point is: depending on your objective, your loss function changes, so the answer will show you your mathematically optimal decision to make, which is pretty neat.`,
    },
  ],
},
  {
